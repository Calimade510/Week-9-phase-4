...
def GetUserName():
    ...
    GetUserName = input('Enter username or enter End to quit: ')
    return username
def GetUserPassword():
    ##### write the code to enter the pwd and return pwd
    GetUserPassworg = input('Enter user password: ')
    return pwd
def GetUserRole():
      ...
      # only admin users can enter data
        ...
        while true:
            ...
            if (UserRole == 'Admin'):
                ...
                print('Users are permitted read only access')
